// ─────────────────────────────────────────────────────────────────
//  Product Seed Script — Posts products via the running backend API
//  1. Start the backend first:  npm start   (in /backend folder)
//  2. Then run this:            node seedViaApi.js
// ─────────────────────────────────────────────────────────────────
...
const products = [
  ...
  },
  {
    ...
    price: 799, originalPrice: 1099, category: "Plants", subcategory: "Planters & Pots",
...
// ── Main ──────────────────────────────────────────────────────────
async function seed() {
  console.log(`🚀 Seeding ${products.length} products via API at ${API_BASE}…\n`);
  let ok = 0, fail = 0;
  ...
  console.log(`💡 Visit http://localhost:${PORT}/api/products to verify.`);
}
